...
// | Kenji ITO              mystralkk AT gmail DOT come                        |
// |                                                                           |
...
$LANG_MG01 = array (
    ...
    'album_delete_help'         => 'This will delete the album and all sub-albums of this one.  You must select whether to move the media items to a new folder or to delete them permanently.<br' . XHTML . '><strong>You cannot undo a delete</strong>',
    ...
    'media_manage_help'         => 'Move and Delete will perform batch operations on the selected items.  Save will update the sequence, album cover and the media titles.<br' . XHTML . '><strong>Deletes are permanent!  There is no undo!</strong>',
    ...
    'global_attr_help'          => 'This will change the attributes for <strong>ALL</strong> of your albums, use with caution!<br' . XHTML . '><br' . XHTML . '>Select which fields you wish to update by choosing their value and selecting the <strong>Update</strong> checkbox.',
    'globalperm'                => 'Global Perm Edit',
    'global_perm_editor'        => 'Global Album Permissions Editor',
    'global_perm_help'          => 'This will change the permissions for <strong>ALL</strong> of your albums, use with caution!<br' . XHTML . '><br' . XHTML . '>Select which fields you wish to update by choosing their value and selecting the <strong>Update</strong> checkbox.',
    'attribute'                 => 'Attribute',
    'value'                     => 'Value',
    'update'                    => 'Update',
    ...
    'remove_details'            => 'This process will remove all the originally uploaded images, leaving only the display image and the thumbnail.<br' . XHTML . '><br' . XHTML . '><strong>There is no UNDO, be sure this is what you want to do!</strong>',
    ...
    'upload'                    => 'Upload',
    'watermark_manage_help'     => 'Allows you to add / delete watermark images. Maximum watermark file size is 64kb.<br' . XHTML . '><strong>Deletes are permanent!  There is no undo!</strong>',
    ...
    'preview'                   => 'Preview',
    'wm_upload_help'            => 'Click the Browse to locate a media to upload - Supported File Types: .GIF, .PNG, .JPG. <br' . XHTML . '><strong>Maximum watermark file size is 64kb.</strong>',
    ...
    'owner'                     => 'Owner',
    'remove_error'              => 'You can only remove the original images if <strong>Discard Original Images</strong> is enabled in System Options',
    'file_list'                 => 'File List',
...
$LANG_MG03 = array (
    ...
    'upload_size'           => '<strong>Note:</strong> You can upload up to %s megabytes at one time. No individual file may be larger than %s megabytes. If you want to upload more than that, you must upload the files separately, use a different upload format, or ask your system administrator to allow larger uploads.',
